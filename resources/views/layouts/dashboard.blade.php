...
<head>
    ...
    <title>Dashboard - HRIS App</title>
...
<body>
                        ...
                        <!-- <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item  ">
                                    <a href="{{ asset('dist/component-accordion.html') }}"
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    <div class="float-start">
                        <p>2023 &copy; HrisApp</p>
                    </div>
                    <div class="float-end">
                        <p>Crafted with <span class="text-danger"><i class="bi bi-heart-fill icon-mid"></i></span>
                            by <a href="https://github.com/muhamadmuhibudin">Muhammad Muhibbudin</a></p>
                    </div>
                </div>
            </footer>
        </div>
    ...
    // handling for all succesfully tasks
    @if(session('success'))
        Swal.fire({
            icon: 'success',
            title: 'Success',
